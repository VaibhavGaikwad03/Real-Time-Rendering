...
struct MyPoint point_vtg; // declaring a single variable of type 'struct MyPoint' globally...

struct MyPointProperties point_properties_vtg; // declaring a single variable of type 'struct MyPointProperties' globally...
