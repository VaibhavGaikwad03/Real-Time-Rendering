...
int main(void)
{
    ...
    // read bacl result from the device (i.e from deviceC) into cpu variable (i.e hostC)
...
void matMulCPU(int *A, int *B, int *C, int numARows, int numAColumns, int numBColumns, int numCColoumns)
{
    StopWatchInterface *timer = NULL;
    sdkCreateTimer(&timer);
    sdkStartTimer(&timer);
