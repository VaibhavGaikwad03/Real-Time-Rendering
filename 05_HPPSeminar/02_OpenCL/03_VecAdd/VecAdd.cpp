...
int main(void)
{
    ...
    // read bacl result from the device (i.e from deviceOutput) into cpu variable (i.e hostOutput)
...
void cleanup(void)
{
    ...
    // gold la pn yogya thikani free kr
}