...
int main(void)
{
    ...
    printf("Size of matrix gold hostA = %d\n", sizeA);
    printf("Size of matrix gold hostB = %d\n", sizeB);
    printf("Size of matrix gold hostC = %d\n", sizeC);
    printf("Size of matrix gold gold = %d\n", sizeGold);
    ...
    printf("Time taken for matrix multiplication of CPU = %.6f\n", timeOnCPU);
    printf("Time taken for matrix multiplication of GPU = %.6f\n", timeOnGPU);
    printf("%s\n", str);
