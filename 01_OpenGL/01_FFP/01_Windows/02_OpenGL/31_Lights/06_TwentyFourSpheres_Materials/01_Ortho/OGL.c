...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
        ...
        case 'x':
            ...
            angleForXRotation = 0.0f; // resettng angle for x rotation
        ...
        case 'y':
            ...
            angleForYRotation = 0.0f; // resettng angle for y rotation
        ...
        case 'z':
            ...
            angleForZRotation = 0.0f; // resettng angle for z rotation
...
void draw24Spheres(void)
{
    ...
    GLfloat materialShinieness;

    // code
    // first sphere of fist column
    materialAmbient[0] = 0.0215f;
    materialAmbient[1] = 0.1745f;
    materialAmbient[2] = 0.02215;
    ...
    materialShinieness = 0.6f * 128;

    glMaterialf(GL_FRONT, GL_SHININESS, materialShinieness);
    ...
    materialShinieness = 0.21794872 * 128;
    ...
    // second sphere of second column
    ...
    materialShinieness = 0.078125 * 128;
