...
GLfloat lightAmbient0[] = {0.0f, 0.0f, 1.0f};
GLfloat lightDiffuse0[] = {1.0f, 0.0f, 0.0f, 1.0f};
GLfloat lightSpecular0[] = {1.0f, 0.0f, 0.0, 1.0f};
GLfloat lightPosition0[] = {-2.0f, 0.0f, 0.0f, 1.0f}; // if non-zero then light is "positional" and if value is zero then light is "directional"

GLfloat lightAmbient1[] = {0.0f, 0.0f, 1.0f};
GLfloat lightDiffuse1[] = {0.0f, 0.0f, 1.0f, 1.0f};
GLfloat lightSpecular1[] = {0.0f, 0.0f, 1.0, 1.0f};
...
int initialize(void)
{
    ...
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, materialAmbient); // front kiva front and back donhi use karu shakto. depend krta ki tumchyakade lights jast astil tr tumhi front and back he use karu shakta. maybe gluLookAt kela tr front and back cha use hou shakto... MAYBE...
