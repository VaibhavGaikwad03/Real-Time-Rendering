...
void DrawB(float ox, float oy)
{
    glBegin(GL_POLYGON); // upper right

    glColor3f(1.0f, 0.4039f, 0.1215f);
    ...
    glVertex2f(0.2f + ox, -0.05f + oy);
    glVertex2f(0.1f + ox, 0.05f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(0.1f + ox, -0.4f + oy);
    glVertex2f(0.15f + ox, -0.4f + oy);
    glVertex2f(0.2f + ox, -0.35f + oy);
    ...
    glColor3f(1.0f, 0.4039f, 0.1215f); // upper horizontal
    glVertex2f(0.1f + ox, 0.4f + oy);
    glVertex2f(-0.2f + ox, 0.4f + oy);
    glColor3f(1.0f, 0.552f, 0.341f);
    glVertex2f(-0.2f + ox, 0.3f + oy);
    glVertex2f(0.1f + ox, 0.3f + oy);

    glColor3f(0.2392f, 0.549f, 0.396f); // lower horizontal
    glVertex2f(0.1f + ox, -0.3f + oy);
    glVertex2f(-0.2f + ox, -0.3f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(-0.2f + ox, -0.4f + oy);
    ...
    glColor3f(1.0f, 0.4039f, 0.1215f); // left vertical lower
    glVertex2f(-0.1f + ox, 0.4f + oy);
    glVertex2f(-0.2f + ox, 0.4f + oy);
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    glColor3f(1.0f, 1.0f, 1.0f); // middle
    glVertex2f(-0.2f + ox, 0.05f + oy);
    glVertex2f(-0.2f + ox, -0.05f + oy);
    glVertex2f(0.1f + ox, -0.05f + oy);
    glVertex2f(0.1f + ox, 0.05f + oy);

    glColor3f(1.0f, 1.0f, 1.0f); // left vertical upper
    glVertex2f(-0.1f + ox, 0.0f + oy);
    glVertex2f(-0.2f + ox, 0.0f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(-0.2f + ox, -0.4f + oy);
...
void DrawH(float ox, float oy)
{
    ...
    glColor3f(1.0f, 0.4039f, 0.1215f); // right vertical lower
    glVertex2f(0.1f + ox, 0.4f + oy);
    glVertex2f(0.2f + ox, 0.4f + oy);
    glColor3f(1.0f, 1.0f, 1.0f);
    glVertex2f(0.2f + ox, 0.0f + oy);
    ...
    glColor3f(1.0f, 1.0f, 1.0f); // right vertical upper
    glVertex2f(0.1f + ox, 0.0f + oy);
    glVertex2f(0.2f + ox, 0.0f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(0.2f + ox, -0.4f + oy);
...
void DrawA(float ox, float oy)
{
    ...
    glColor3f(1.0f, 0.552f, 0.341f); // left vertical upper
    glVertex2f(-0.1f + ox, 0.3f + oy);
    glVertex2f(-0.2f + ox, 0.3f + oy);
    glColor3f(1.0f, 1.0f, 1.0f);
    glVertex2f(-0.2f + ox, 0.0f + oy);
    ...
    glColor3f(1.0f, 1.0f, 1.0f); // left vertical lower
    glVertex2f(-0.1f + ox, 0.0f + oy);
    glVertex2f(-0.2f + ox, 0.0f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(-0.2f + ox, -0.4f + oy);
    ...
    glColor3f(1.0f, 0.552f, 0.341f); // right vertical upper
    glVertex2f(0.1f + ox, 0.3f + oy);
    glVertex2f(0.2f + ox, 0.3f + oy);
    glColor3f(1.0f, 1.0f, 1.0f);
    glVertex2f(0.2f + ox, 0.0f + oy);
    ...
    glColor3f(1.0f, 1.0f, 1.0f); // right vertical lower
    glVertex2f(0.1f + ox, 0.0f + oy);
    glVertex2f(0.2f + ox, 0.0f + oy);
    glColor3f(0.0156f, 0.4156f, 0.2196f);
    glVertex2f(0.2f + ox, -0.4f + oy);
...
void DrawT(float ox, float oy)
{
    ...
    glColor3f(1.0f, 0.4039f, 0.1215f); // middle
    glVertex2f(0.2f + ox, 0.4f + oy);
    glVertex2f(-0.2f + ox, 0.4f + oy);
    glColor3f(1.0f, 0.552f, 0.341f);
    glVertex2f(-0.2f + ox, 0.3f + oy);
