...
void resize(int width, int height)
{
    ...
    float top = nearValue * tan(fovy_rad / 2.0f);
    float bottom = -top;
    float right = top * aspect;
    float left = -right;

    perspectiveMatrix[0] = (2.0f * nearValue) / (right - left);
    perspectiveMatrix[1] = 0.0f;
    perspectiveMatrix[2] = 0.0f;
    perspectiveMatrix[3] = 0.0f;
    perspectiveMatrix[4] = 0.0f;
    perspectiveMatrix[5] = (2.0f * nearValue) / (top - bottom);
    perspectiveMatrix[6] = 0.0f;
    perspectiveMatrix[7] = 0.0f;
    perspectiveMatrix[8] = (right + left) / (right - left);
    perspectiveMatrix[9] = (top + bottom) / (top - bottom);
    perspectiveMatrix[10] = -(farValue + nearValue) / (farValue - nearValue);
    perspectiveMatrix[11] = -1.0f;
    perspectiveMatrix[12] = 0.0f;
    perspectiveMatrix[13] = 0.0f;
    perspectiveMatrix[14] = -(2.0f * farValue * nearValue) / (farValue - nearValue);
