...
void loadGLTexture(void)
{
    ...
    // if value is 1: don't do unpacking by row column method by using any byte size
    // if value is 2: do unpacking by a number divisible by two
    // if value is 4: do unpacking by a RGBA row column method
