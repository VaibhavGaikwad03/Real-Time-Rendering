...
int initialize(void)
{
    ...
    gluQuadricTexture(quadric, GL_TRUE);    // Enable texture coords
    gluQuadricNormals(quadric, GLU_SMOOTH); // Optional: for lighting
...
void updateAnimation()
{
    ...
    // const static float animationSpeed = 0.1f;
    ...
    {
        transformationXLetterB += calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterB >= 0.0f) // H
    {
        ...
        {
            transformationXLetterH += calculateIncrementPerFrame(animationSpeed);
        ...
        {
            transformationYLetterH -= calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterH >= 0.0f) // A
    {
        ...
        {
            transformationXLetterA1 += calculateIncrementPerFrame(animationSpeed);
        ...
        {
            transformationYLetterA1 += calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterA1 >= 0.0f) // R
    {
        ...
        {
            transformationXLetterR -= calculateIncrementPerFrame(animationSpeed);
        ...
        {
            transformationYLetterR -= calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterR <= 0.0f) // A
    {
        ...
        {
            transformationXLetterA2 -= calculateIncrementPerFrame(animationSpeed);
        ...
        {
            transformationYLetterA2 += calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterA2 <= 0.0f) // T
    {
        ...
        {
            transformationXLetterT -= calculateIncrementPerFrame(animationSpeed);
    ...
    if (transformationXLetterT <= 0.0f)
    {
        ...
        {
            plane1StartingTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }

        if (plane1FinalXCoordinate >= 0.55f / planeScalef) // ending
        {
            plane1EndingTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }

        if (plane1FinalXCoordinate >= -(0.55f / planeScalef) && plane1FinalXCoordinate <= 0.55f / planeScalef) // middle
        {
            plane1MiddleTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }
        ...
        {
            letterBAlpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }

        if (plane1FinalXCoordinate >= -(0.3559 - 0.16175) / planeScalef)
        {
            letterHAlpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }

        if (plane1FinalXCoordinate >= -(0.1618 - 0.16175) / planeScalef)
        {
            letterA1Alpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }

        if (plane1FinalXCoordinate >= (0.0324 + 0.16175) / planeScalef)
        {
            letterRAlpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }

        if (plane1FinalXCoordinate >= (0.2265 + 0.16175) / planeScalef)
        {
            letterA2Alpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }

        if (plane1FinalXCoordinate >= (0.4205) / planeScalef)
        {
            letterTAlpha += calculateIncrementPerFrameFromValues(0.0f, 1.0f, 0.1294, calculateIncrementPerFrame(planeTransformationSpeed));
        }
        ...
        {
            plane3StartingTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }

        if (plane3FinalXCoordinate >= 0.55f / planeScalef) // ending
        {
            plane3EndingTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }

        if (plane3FinalXCoordinate >= -(0.55f / planeScalef) && plane3FinalXCoordinate <= 0.55f / planeScalef) // middle
        {
            plane3MiddleTransformation += calculateIncrementPerFrame(planeTransformationSpeed);
        }
    }
}
...
void display(void)
{
    ...
    glRotatef(sphereRotation, 0.0f, 0.0f, 1.0f);
    ...
    struct Color4f color = {0.0f, 0.0f, 0.2509f, 1.0f};
    DrawIndiaMap(30.0f, 35.0f, color);
...
{
    // const static float animationSpeed = 0.0025f;
    sphereRotation -= 0.02f;
    if (sphereRotation <= 0.0f)
    {
