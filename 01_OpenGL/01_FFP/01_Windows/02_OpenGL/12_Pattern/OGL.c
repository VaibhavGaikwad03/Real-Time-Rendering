...
void DrawUpperRightShape(float ox, float oy)
{
    // upper right shape
    glBegin(GL_LINES);

    glVertex2f(0.1f + ox, 0.1f + oy);
    glVertex2f(-0.1f + ox, 0.1f + oy);
    ...
    glVertex2f(0.033f + ox, 0.1f + oy);
    glVertex2f(0.033f + ox, -0.1f + oy);

    glVertex2f(-0.033f + ox, 0.1f + oy);
    glVertex2f(-0.033f + ox, -0.1f + oy);

    glVertex2f(-0.1f + ox, 0.033f + oy);
    glVertex2f(0.1f + ox, 0.033f + oy);
...
void DrawUpperLeftShape(float ox, float oy)
{
    glPointSize(2.0f);
    ...
    // row 2
    glVertex2f(0.1f + ox, 0.033f + oy);
    glVertex2f(0.033f + ox, 0.033f + oy);
    glVertex2f(-0.033f + ox, 0.033f + oy);
    glVertex2f(-0.1f + ox, 0.033f + oy);
...
void DrawUpperMiddleShape(float ox, float oy)
{
    // upper middle shape
    glBegin(GL_LINES);
...
void DrawLowerLeftShape(float ox, float oy)
{
    glBegin(GL_LINES);
...
void DrawLowerMiddleShape(float ox, float oy)
{
    glBegin(GL_LINES);
...
void DrawLowerRightShape(float ox, float oy)
{
    glBegin(GL_QUADS);
    ...
    DrawUpperRightShape(ox, oy);
}

void DrawPatterns(float ox, float oy)
{
    DrawUpperMiddleShape(ox, oy + 0.5f);
    DrawUpperRightShape(ox + 0.5f, oy + 0.5f);
    DrawUpperLeftShape(ox + (-0.5f), oy + 0.5f);
    DrawLowerLeftShape(ox + (-0.5f), oy + (-0.5f));
    DrawLowerMiddleShape(ox, oy + (-0.5f));
    DrawLowerRightShape(ox + 0.5f, oy + (-0.5f));
}
