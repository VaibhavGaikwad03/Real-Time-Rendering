...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    int xPos = rcWork.left + (rcWork.right - rcWork.left - WIN_WIDTH) / 2;
    int yPos = rcWork.top + (rcWork.bottom - rcWork.top - WIN_HEIGHT) / 2;

    // Creates window
    hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Vaibhav Tukaram Gaikwad"),
